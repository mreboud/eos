    ...
    public:
        ...
        virtual void run() const
        {
            ...
            // than the channel masses, one recover a simple Breit-Wigner distribution
            {
                ...
                const double BWfactoratmres = kmatrix_utils::blatt_weisskopf_factor(chan->_l_orbital,
                ...
                const double BWfactorat300  = kmatrix_utils::blatt_weisskopf_factor(chan->_l_orbital,
