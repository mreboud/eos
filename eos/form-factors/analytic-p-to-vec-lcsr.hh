...
#ifndef EOS_GUARD_EOS_FORM_FACTORS_ANALYTIC_P_TO_VEC_LCSR_HH
#define EOS_GUARD_EOS_FORM_FACTORS_ANALYTIC_P_TO_VEC_LCSR_HH 1
...
namespace eos
{
    ...
    class AnalyticFormFactorPToVLCSR :
        public FormFactors<PToV>,
        PrivateImplementationPattern<AnalyticFormFactorPToVLCSR<Process_>>
    {
        public:
            AnalyticFormFactorPToVLCSR(const Parameters &, const Options &);
            ~AnalyticFormFactorPToVLCSR();
            ...
            /* First moments of the sum rules, if the SR is fulfiled, a_1_dsr = mB^2 */
    ...
    extern template class AnalyticFormFactorPToVLCSR<BToRho>;
    extern template class AnalyticFormFactorPToVLCSR<BToKstar>;
    extern template class AnalyticFormFactorPToVLCSR<BsToKstar>;
}
#endif
