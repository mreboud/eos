...
namespace eos
{
    ...
    template <> class KKRvD2024FormFactors<VacuumToPiPi> : public FormFactors<VacuumToPP>
    {
        private:
            ...
            std::array<UsedParameter, 8u> _c_fp_I0;
            UsedParameter                 _M_fp_I0;
            UsedParameter                 _G_fp_I0;
        ...
        public:
            ...
            // functions for applying the constraints on f+, I=0 projection
            std::array<double, 2> _SolveConstraints(const complex<double> & zr) const;
            ...
            double          c_0() const;         // value of the series coefficient c_0
            double          c_1() const;         // value of the series coefficient c_1
