...
namespace eos
{
    ...
    complex<double> GMKPRDEY2011ScatteringAmplitudes::scattering_amplitude(const double & s, const unsigned & l, const Isospin & i) const
    {
        if (s <= 4 * _mPi * _mPi)
        {
            return 0.0;
    ...
    complex<double> GMKPRDEY2011ScatteringAmplitudes::omnes_factor(const double & s, const unsigned & l, const Isospin & i) const
    {
        if ((l == 0) && (i == Isospin::zero))
        {
    ...
    complex<double> GMKPRDEY2011ScatteringAmplitudes::isospin_breaking(const double & s, const unsigned & l, const Isospin & i) const
    {
    ...
    complex<double> GMKPRDEY2011ScatteringAmplitudes::omnes_outer_function(const double & s, const double & sp, const double & s0, const unsigned & npoints, const unsigned & l, const Isospin & i) const
    {
