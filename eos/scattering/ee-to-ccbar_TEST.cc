    ...
    public TestCase
{
    ...
    eetoccbarTest() :
        ...
        virtual void run() const
        {
            ...
            // Set all cst to zero
            p["ee->ccbar::c_0(e^+e^-,e^+e^-)"] = 0.0;
            p["ee->ccbar::c_0(e^+e^-,D^0Dbar^0)"] = 0.0;
            p["ee->ccbar::c_0(e^+e^-,D^+D^-)"] = 0.0;
            ...
            std::array<std::array<std::array<Parameter, 3>, 3>, 1> bkgcst {
                ...
                p["ee->ccbar::c_0(e^+e^-,D^0Dbar^0)"], p["ee->ccbar::c_0(D^0Dbar^0,D^0Dbar^0)"], p["ee->ccbar::c_0(D^0Dbar^0,D^+D^-)"],
                p["ee->ccbar::c_0(e^+e^-,D^+D^-)"],    p["ee->ccbar::c_0(D^0Dbar^0,D^+D^-)"],    p["ee->ccbar::c_0(D^+D^-,D^+D^-)"],
            };
            ...
            auto ee        = std::make_shared<EffChannel<3, 2, 0>>("ee", p["mass::e"], p["mass::e"], ee_g0s);
            auto D0Dbar0   = std::make_shared<PWavePPChannel<3, 2, 0>>("D0Dbar0", p["mass::D^0"], p["mass::D^0"], D0Dbar0_g0s);
            auto DpDm      = std::make_shared<PWavePPChannel<3, 2, 0>>("DpDm", p["mass::D^+"], p["mass::D^+"], DpDm_g0s);

            KMatrix<3, 2, 0> KMatrix32({ee, D0Dbar0, DpDm}, {psi2S, psi3770}, bkgcst, "ee->ccbar");
