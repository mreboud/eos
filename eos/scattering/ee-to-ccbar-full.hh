...
#ifndef EOS_GUARD_EOS_SCATTERING_EETOCCBARFULL_HH
#define EOS_GUARD_EOS_SCATTERING_EETOCCBARFULL_HH 1
...

{
    ...
    */
    ...
    struct EffChannelFull :
    public KMatrix<nchannels_, nresonances_, order_>::Channel
    {

        EffChannelFull(std::string name, double m1, double m2, std::array<Parameter, nresonances_> g0s) :
    ...
    // V -> PP channel
    template <unsigned nchannels_, unsigned nresonances_, unsigned order_>
    struct PWavePPChannelFull :
    public KMatrix<nchannels_, nresonances_, order_>::Channel
    {

        PWavePPChannelFull(std::string name, double m1, double m2, std::array<Parameter, nresonances_> g0s) :
    ...
    // V -> VP channel
    template <unsigned nchannels_, unsigned nresonances_, unsigned order_>
    struct PWaveVPChannelFull :
    public KMatrix<nchannels_, nresonances_, order_>::Channel
    {

        PWaveVPChannelFull(std::string name, double m1, double m2, std::array<Parameter, nresonances_> g0s) :
            KMatrix<nchannels_, nresonances_, order_>::Channel(name, m1, m2, 1, g0s)
        {
        };
    ...
    // V -> VV channel
    template <unsigned nchannels_, unsigned nresonances_, unsigned order_>
    struct PWaveVVChannelFull :
    public KMatrix<nchannels_, nresonances_, order_>::Channel
    {

        PWaveVVChannelFull(std::string name, double m1, double m2, std::array<Parameter, nresonances_> g0s) :
            KMatrix<nchannels_, nresonances_, order_>::Channel(name, m1, m2, 1, g0s)
        {
        };
    ...
    // V -> VV channel
    template <unsigned nchannels_, unsigned nresonances_, unsigned order_>
    struct FWaveVVChannelFull :
    public KMatrix<nchannels_, nresonances_, order_>::Channel
    {

        FWaveVVChannelFull(std::string name, double m1, double m2, std::array<Parameter, nresonances_> g0s) :
    ...
    template <unsigned nchannels_, unsigned nresonances_, unsigned order_>
    struct CharmoniumResonanceFull :
    public KMatrix<nchannels_, nresonances_, order_>::Resonance
    {
        CharmoniumResonanceFull(std::string name, Parameter m, Parameter q) :
    ...
    class EEToCCBarFull :
        ...
        public PrivateImplementationPattern<EEToCCBarFull>
    {
        public:
            ...
            */
            ...
            EEToCCBarFull(const Parameters & parameters, const Options & options);
            ~EEToCCBarFull();
